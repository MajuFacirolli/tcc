...
CREATE TYPE "public"."campaign_status" AS ENUM('active', 'draft', 'closed');--> statement-breakpoint
...
ALTER TABLE "confirmations" ADD CONSTRAINT "confirmations_donor_id_donors_id_fk" FOREIGN KEY ("donor_id") REFERENCES "public"."donors"("id") ON DELETE no action ON UPDATE no action;